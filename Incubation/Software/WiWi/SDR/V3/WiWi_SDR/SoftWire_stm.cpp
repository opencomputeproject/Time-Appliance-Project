...
void SoftWire::sdaLow(const SoftWire *p)
{
...

  {
    ...
    wwvb_gpio_pinmode_pullup(sda, OUTPUT);
  }
}
...
{
  wwvb_gpio_pinmode_pullup(p->getSda(), p->getInputMode());
}
...
void SoftWire::sclLow(const SoftWire *p)
{
...

  {
    ...
    wwvb_gpio_pinmode_pullup(scl, OUTPUT);
  }
}
...
{
  wwvb_gpio_pinmode_pullup(p->getScl(), p->getInputMode());
}
