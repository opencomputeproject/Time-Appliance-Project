...
WWVB_Pin WWVB_Pins[] = {
  ...
  PIN_STRUCT(ICE_CDONE),
  PIN_STRUCT(ICE_CRESET),
  PIN_STRUCT(ICE_CFG_SCK),
  PIN_STRUCT(ICE_CFG_MISO),
  PIN_STRUCT(ICE_CFG_MOSI),
  PIN_STRUCT(ICE_CFG_SS),
  PIN_STRUCT(ICE_SPARE1),
  PIN_STRUCT(ICE_SPARE2),
  PIN_STRUCT(ICE_SPARE3),
  PIN_STRUCT(ICE_SPARE4),
  PIN_STRUCT(ICE_SPARE5),

  PIN_STRUCT(RCB_UART_TX),
  PIN_STRUCT(RCB_UART_RX),
  PIN_STRUCT(RCB_I2C_SCL),
  PIN_STRUCT(RCB_I2C_SDA),
  PIN_STRUCT(RCB_PPS_OUT),
  PIN_STRUCT(RCB_PPS_IN),
