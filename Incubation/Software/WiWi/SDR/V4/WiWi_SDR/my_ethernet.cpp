...
void onEthernetDHCPTest(EmbeddedCli *cli, char *args, void *context)
{
  Serial.println("DHCP test!");
...
static Node ethernet_dhcp_test_node = { .name = "", 
  .type = MY_FILE, 
  .cliBinding = {
    "dhcp_test",
    "Test function for DHCP",
    true,
    nullptr,
    onEthernetDHCPTest
  }
...
static Node * ethernet_files[] = { &ethernet_mac_node, &ethernet_dhcp_test_node };
