...
#define FPGA_INITN_N GPIO_PIN_7
#define FPGA_INITN_G GPIOA

#define FPGA_EIO_N GPIO_PIN_13
#define FPGA_EIO_G GPIOB

#define FPGA_DONE_N GPIO_PIN_5
#define FPGA_DONE_G GPIOA
