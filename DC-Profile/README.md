...
[4.1Model 1 – Transparent Clock Model 6](#_Toc81400014)

[5Model 1 - Additional Requirements 8](#_Toc81400015)

[6PTP Profile 8](#_Toc81400016)

[6.1Profile Identifier 8](#_Toc81400017)

[6.2Clock Types 8](#_Toc81400018)

[6.3Message Types 9](#_Toc81400019)

[6.4Transport mechanisms required, permitted, or prohibited 9](#_Toc81400020)

[6.5Clock identity 9](#_Toc81400021)

[6.6Path delay Measurement Mechanism 10](#_Toc81400022)

[6.7Class of Service 10](#_Toc81400023)

[6.8PTP Security 10](#_Toc81400024)

[6.9Profile Isolation and Domain Number 10](#_Toc81400025)

[6.10One-step and two-step operation 11](#_Toc81400026)

[6.11End-to-End TC with two-step operation 11](#_Toc81400027)

[6.12PTP message rate 12](#_Toc81400028)

[6.13PTP inter-message interval 12](#_Toc81400029)

[6.14Unicast Communication 13](#_Toc81400030)

[6.14.1Unicast Discovery 13](#_Toc81400031)

[6.14.2Unicast Negotiation 14](#_Toc81400032)

[6.14.3Active Standby Scenario 17](#_Toc81400033)

[6.14.4Active Active Scenario 20](#_Toc81400034)

[6.15Best Clock Algorithm and Clock Attributes 20](#_Toc81400035)

[6.16Network Limits and Error Budget for Model 1 23](#_Toc81400036)

[6.17PTP management messages 25](#_Toc81400037)

[7References 26](#_Toc81400038)

[8Revision 26](#_Toc81400039)

[9License 27](#_Toc81400040)
...
- GM (or Open Time Server) has a single network physical port and always distribute time towards the network fabric layer and server layer. The GM defined in this PTP profile (and the term GM used in this document) is a leader-only
# 1
 OC with a single PTP port according to 9.2.2.2 of IEEE Std 1588-2019.
- TC can have multiple network physical ports (eg., 16, 48). The TC can have multiple capable PTP ports.
- OC has a single network physical port and always receives time from the network fabric layer and the GM. The OC defined in this PTP profile (and the term OC used in this document) is a follower-only
# 2
 OC according to 9.2.2.1 of IEEE Std 1588-2019.
...
- The maximum time error between any two OCs must be within 5 microseconds, i.e., |TOC,_j_ – TOC,_k_|  5 s for _k__j._
- The maximum time error between a GM and any OCs must be within 2.5 microseconds. i.e., |TGM – TOC|  2.5 s.
- The maximum time error between any two GMs must be within 100 nanoseconds, i.e., |TGM,j – TGM,k |  100 ns for _k__j._
