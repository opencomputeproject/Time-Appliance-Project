...
set_clock_groups -logically_exclusive -group DummyClk -group userclk1 -group Mhz200Clk -group Mhz10Clk -group Mhz10ClkExt -group Mhz10ClkDcxo1
...
set_false_path -from [get_clocks userclk1] -to [get_clocks PllDynMhz50Clk_Src4]
set_false_path -from [get_clocks PllDynMhz50Clk_Src4] -to [get_clocks userclk1]
set_max_delay -from [get_clocks PllDynMhz50Clk_Src4] -to [get_clocks userclk1] 5.000
set_max_delay -from [get_clocks userclk1] -to [get_clocks PllDynMhz50Clk_Src4] 5.000
