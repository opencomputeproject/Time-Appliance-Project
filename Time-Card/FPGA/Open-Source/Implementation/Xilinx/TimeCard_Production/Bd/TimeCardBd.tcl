...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.VersionNumber_Gen {0x8001} \
   CONFIG.VersionNumber_Golden_Gen {0x8001} \
 ] $TC_FpgaVersion_0
  ...
  set axi_iic_eeprom [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.0 axi_iic_eeprom ]

  # Create instance: axi_iic_rgb, and set properties
  set axi_iic_rgb [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.0 axi_iic_rgb ]
