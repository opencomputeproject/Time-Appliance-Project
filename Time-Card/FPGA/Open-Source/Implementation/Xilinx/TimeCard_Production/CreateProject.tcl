...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7z015clg485-1 -force
...
# --! to create the BD tcl: write_bd_tcl [[LOCAL_PATH]]/Implementation/Xilinx/TimeCard_Production/Bd/TimeCardBd.tcl -force 
