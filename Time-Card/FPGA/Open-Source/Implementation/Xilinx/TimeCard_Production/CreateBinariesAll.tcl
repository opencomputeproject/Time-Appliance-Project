...
exec "$ScriptFolder/Additional Files/tft" -input $ScriptFolder/Binaries/TimeCardOS_Production.bin -output $ScriptFolder/Binaries/TimeCardOS_Production_Gotham.bin -vendor $VID -device $DID -apply
