...
set_clock_groups -logically_exclusive -group clk1mux -group clk2mux -group {PllFixMhz50Clk InternalMhz200Clk}

create_generated_clock -name clk3mux -divide_by 1 -add -master_clock Mhz10ClkDcxo1 -source [get_pins Bd_Inst/TimeCard_i/BufgMux_IPI_1/U0/BufgMux_Inst/I0] [get_pins Bd_Inst/TimeCard_i/BufgMux_IPI_1/U0/BufgMux_Inst/O]
set_clock_groups -logically_exclusive -group clk3mux -group {PllFixMhz50Clk InternalMhz200Clk}
...
create_generated_clock -name clk3mux_cas -divide_by 1 -add -master_clock clk3mux -source [get_pins Bd_Inst/TimeCard_i/BufgMux_IPI_2/U0/BufgMux_Inst/I1] [get_pins Bd_Inst/TimeCard_i/BufgMux_IPI_2/U0/BufgMux_Inst/O]
set_clock_groups -logically_exclusive -group clk1mux_cas -group clk2mux_cas -group clk3mux_cas -group {PllFixMhz50Clk InternalMhz200Clk}
# Clock Wiz1
...
create_generated_clock -name InternalMhz200Clk_Src3 -source [get_pins Bd_Inst/TimeCard_i/clk_wiz_1/inst/mmcm_adv_inst/CLKIN1] -master_clock clk3mux_cas [get_pins Bd_Inst/TimeCard_i/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0]
set_clock_groups -logically_exclusive -group InternalMhz200Clk_Src1 -group InternalMhz200Clk_Src2 -group InternalMhz200Clk_Src3 -group {PllFixMhz50Clk InternalMhz200Clk}
...
create_generated_clock -name PllDynMhz50Clk_Src4 -source [get_pins Bd_Inst/TimeCard_i/clk_wiz_2/inst/mmcm_adv_inst/CLKIN2] -master_clock InternalMhz200Clk_Src3 [get_pins Bd_Inst/TimeCard_i/clk_wiz_2/inst/mmcm_adv_inst/CLKOUT0]
set_clock_groups -logically_exclusive -group PllDynMhz50Clk_Src1 -group PllDynMhz50Clk_Src2 -group PllDynMhz50Clk_Src3 -group PllDynMhz50Clk_Src4 -group {PllFixMhz50Clk InternalMhz200Clk}
...
set_input_delay -clock [get_clocks DummyClk] -min 0.000 [get_ports {UartGnss2RxDat_DatIn}]
set_input_delay -clock [get_clocks DummyClk] -max 5.000 [get_ports {UartGnss2RxDat_DatIn}]

set_output_delay -clock [get_clocks DummyClk] -min 15.000 [get_ports {UartGnss2TxDat_DatOut}]
set_output_delay -clock [get_clocks DummyClk] -max 0.000 [get_ports {UartGnss2TxDat_DatOut}]
...
set_input_delay -clock [get_clocks DummyClk] -min 0.000 [get_ports {Key_DatIn[*]}]
set_input_delay -clock [get_clocks DummyClk] -max 5.000 [get_ports {Key_DatIn[*]}]

#**************************************************************
# PCIe
#**************************************************************
set_false_path -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllFixMhz50Clk]
set_false_path -from [get_clocks PllFixMhz50Clk] -to [get_clocks s7pciephy_clkout3]
set_max_delay -from [get_clocks PllFixMhz50Clk] -to [get_clocks s7pciephy_clkout3] 8.000
set_max_delay -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllFixMhz50Clk] 8.000

set_false_path -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src1]
set_false_path -from [get_clocks PllDynMhz50Clk_Src1] -to [get_clocks s7pciephy_clkout3]
set_max_delay -from [get_clocks PllDynMhz50Clk_Src1] -to [get_clocks s7pciephy_clkout3] 8.000
set_max_delay -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src1] 8.000

set_false_path -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src2]
set_false_path -from [get_clocks PllDynMhz50Clk_Src2] -to [get_clocks s7pciephy_clkout3]
set_max_delay -from [get_clocks PllDynMhz50Clk_Src2] -to [get_clocks s7pciephy_clkout3] 8.000
set_max_delay -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src2] 8.000

set_false_path -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src3]
set_false_path -from [get_clocks PllDynMhz50Clk_Src3] -to [get_clocks s7pciephy_clkout3]
set_max_delay -from [get_clocks PllDynMhz50Clk_Src3] -to [get_clocks s7pciephy_clkout3] 8.000
set_max_delay -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src3] 8.000

set_false_path -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src4]
set_false_path -from [get_clocks PllDynMhz50Clk_Src4] -to [get_clocks s7pciephy_clkout3]
set_max_delay -from [get_clocks PllDynMhz50Clk_Src4] -to [get_clocks s7pciephy_clkout3] 8.000
set_max_delay -from [get_clocks s7pciephy_clkout3] -to [get_clocks PllDynMhz50Clk_Src4] 8.000

set_false_path -from [get_clocks DummyClk] -to [get_clocks s7pciephy_clkout0]
set_false_path -from [get_clocks s7pciephy_clkout0] -to [get_clocks DummyClk]

set_false_path -from [get_clocks DummyClk] -to [get_clocks s7pciephy_clkout1]
set_false_path -from [get_clocks s7pciephy_clkout1] -to [get_clocks DummyClk]

set_false_path -from [get_clocks DummyClk] -to [get_clocks s7pciephy_clkout3]
set_false_path -from [get_clocks s7pciephy_clkout3] -to [get_clocks DummyClk]

set_input_delay -clock [get_clocks DummyClk] -min 0.000 [get_ports {PciePerst_RstIn}]
set_input_delay -clock [get_clocks DummyClk] -max 5.000 [get_ports {PciePerst_RstIn}]
...
set_false_path -from [get_clocks DummyClk] -to [get_clocks PllMhz200Clk_Src4]
set_false_path -from [get_clocks PllMhz200Clk_Src4] -to [get_clocks DummyClk]
...
set_false_path -from [get_clocks DummyClk] -to [get_clocks PllDynMhz50Clk_Src4]
set_false_path -from [get_clocks PllDynMhz50Clk_Src4] -to [get_clocks DummyClk]
...
set_output_delay -clock [get_clocks DummyClk] -min 15.000 [get_ports {MacPps0_EvtOut MacPps1_EvtOut MacUsbPower_EnOut MacUsbP_DatOut MacUsbN_DatOut MacFreqControl_DatOut}]
set_output_delay -clock [get_clocks DummyClk] -max 0.000 [get_ports {MacPps0_EvtOut MacPps1_EvtOut MacUsbPower_EnOut MacUsbP_DatOut MacUsbN_DatOut MacFreqControl_DatOut}]

set_input_delay -clock [get_clocks DummyClk] -min 0.000 [get_ports {MacPps_EvtIn MacAlarm_DatIn MacBite_DatIn}]
set_input_delay -clock [get_clocks DummyClk] -max 5.000 [get_ports {MacPps_EvtIn MacAlarm_DatIn MacBite_DatIn}]

set_output_delay -clock [get_clocks DummyClk] -min 15.000 [get_ports {I2cScl_ClkInOut I2cSda_DatInOut Osc5356Enable_EnOut}]
set_output_delay -clock [get_clocks DummyClk] -max 0.000 [get_ports {I2cScl_ClkInOut I2cSda_DatInOut Osc5356Enable_EnOut}]

set_input_delay -clock [get_clocks DummyClk] -min 0.000 [get_ports {I2cScl_ClkInOut I2cSda_DatInOut}]
set_input_delay -clock [get_clocks DummyClk] -max 5.000 [get_ports {I2cScl_ClkInOut I2cSda_DatInOut}]

set_output_delay -clock [get_clocks DummyClk] -min 15.000 [get_ports {Gnss1RstN_RstOut Gnss2RstN_RstOut}]
set_output_delay -clock [get_clocks DummyClk] -max 0.000 [get_ports {Gnss1RstN_RstOut Gnss2RstN_RstOut}]
...
set_output_delay -clock [get_clocks DummyClk] -min 5.000 [get_ports {Sma1InBufEnableN_EnOut Sma2InBufEnableN_EnOut Sma3InBufEnableN_EnOut Sma4InBufEnableN_EnOut}]
set_output_delay -clock [get_clocks DummyClk] -max 0.000 [get_ports {Sma1InBufEnableN_EnOut Sma2InBufEnableN_EnOut Sma3InBufEnableN_EnOut Sma4InBufEnableN_EnOut}]

set_output_delay -clock [get_clocks DummyClk] -min 5.000 [get_ports {Sma1OutBufEnableN_EnOut Sma2OutBufEnableN_EnOut Sma3OutBufEnableN_EnOut Sma4OutBufEnableN_EnOut}]
set_output_delay -clock [get_clocks DummyClk] -max 0.000 [get_ports {Sma1OutBufEnableN_EnOut Sma2OutBufEnableN_EnOut Sma3OutBufEnableN_EnOut Sma4OutBufEnableN_EnOut}]
