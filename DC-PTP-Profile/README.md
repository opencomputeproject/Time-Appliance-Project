...
- If relevant, the value of the observation interval &ge; τ &gt; used for PTP Variance measurements.
...
- The maximum time error between any two OCs must be within &gt; 5 microseconds, i.e., |TOC,_j_ – TOC,_k_| &gt; 5 μs for _k__j._
