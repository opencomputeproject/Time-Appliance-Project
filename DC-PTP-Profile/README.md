...
Consider _N_ successive inter-message intervals deltat_i, i = 1, 2, ...,N, where deltat_i = (t_i - t_i-1) is as shown in the figure. The  _t_ _i_ , _i_ = 1, 2, …, _N_, where _t_ _i_ = (_t_ _i_ – _t_ _i_-1) is as shown in the figure. The arithmetic mean of the inter-message intervals, _t_ av, is
